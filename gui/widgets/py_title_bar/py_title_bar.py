...
class PyTitleBar(QWidget):
    ...
    def maximize_restore(self, e=None):
        ...
        # HELPER FUNCTION TO HIDE/SHOW RESIZE GRIPS
        def toggle_grips(hide_grips):
            if hasattr(self._parent, "settings") and self._parent.settings.get("custom_title_bar", False):
                grips = [
                    "left_grip",
                    "right_grip",
                    "top_grip",
                ...
                for grip_name in grips:
                    if hasattr(self._parent, grip_name):
                        grip = getattr(self._parent, grip_name)
                        if hide_grips:
                            grip.hide()
                        else:
                            grip.show()
        ...
        if self._parent.isMaximized():
            ...
            # Show resize grips when restoring to normal
            toggle_grips(False)
            ...
            # Hide resize grips when maximizing
            toggle_grips(True)
